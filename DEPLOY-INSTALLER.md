...
```powershell
.\build-release.ps1
.\prepare-installer-manifest.ps1
```
...
`https://d1gvw9ccym1qvn.cloudfront.net/releases/installer-manifest.json`

개발 테스트 시에는 환경변수로 manifest URL만 바꿀 수 있습니다.

```powershell
$env:COTL_INSTALLER_MANIFEST_URL='https://.../test-manifest.json'
.\ChzzkOfTheLamb-Setup-1.0.0.exe
```
