...
- `dist\LambLink-v1.0.0-rc38-distribution.zip`
- `dist\LambLink-v1.0.0-rc38-distribution\USER-DOWNLOAD\LambLink-Setup-1.0.0-rc38.exe`
- `dist\LambLink-v1.0.0-rc38-distribution\CDN-UPLOAD\installer-manifest-1.0.0-rc38.json`
...
7. 로그 경로가 `%LOCALAPPDATA%\LambLink-Staging\companion-rc38.log`인지 확인합니다.
...
운영 `/releases/` 경로와 GitHub Release에는 위 검증을 마친 동일한 RC38 산출물만 승격합니다.
