...
### RC9 verification
`BepInEx/LogOutput.log` must contain `CHZZK Companion Integration 1.0.0 loaded [BUILD=rc9]` and `[RAFFLE][PATCH] explicit raffle hook installation complete` before testing `!신도`.
