...
$fontName = 'COTL-KoreanFontFix-4.2.1-rc32.zip'
...
Copy-Item (Join-Path $root 'DISTRIBUTION-RC32.md') $bundleRoot -Force
...
Write-Host "[OK] RC32 distribution bundle: $bundleZip"
