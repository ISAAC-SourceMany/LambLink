...
$fontName = 'COTL-KoreanFontFix-4.2.1-rc31.zip'
...
Copy-Item (Join-Path $root 'DISTRIBUTION-RC31.md') $bundleRoot -Force
...
Write-Host "[OK] RC31 distribution bundle: $bundleZip"
