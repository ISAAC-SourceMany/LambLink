...
$fontName = 'COTL-KoreanFontFix-4.2.1-rc34.zip'
...
Copy-Item (Join-Path $root 'DISTRIBUTION-RC34.md') $bundleRoot -Force
...
Write-Host "[OK] RC34 distribution bundle: $bundleZip"
