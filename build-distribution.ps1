...
$fontName = 'COTL-KoreanFontFix-4.2.1-rc33.zip'
...
Copy-Item (Join-Path $root 'DISTRIBUTION-RC33.md') $bundleRoot -Force
...
Write-Host "[OK] RC33 distribution bundle: $bundleZip"
