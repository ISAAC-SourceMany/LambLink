...
Tighten Companion-to-mod donation delivery and failure handling in the live runtime.
...
- 보존 소스: `LambLink-v0.1-devbridge10v.zip`
- 보존 시각 기준: `2026-08-23T09:07:36+00:00`
- 이전 스냅샷과의 실제 파일 차이를 사용해 복원함

## 커밋

`fix: harden in-game donation execution`
