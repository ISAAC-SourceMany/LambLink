...
Coordinate raffle overlay state with donation effects and dungeon buffs across the runtime boundary.
...
- 보존 소스: `ChzzkOfTheLamb-v0.1-devbridge10x.zip`
- 보존 시각 기준: `2026-08-23T09:50:02+00:00`
- 이전 스냅샷과의 실제 파일 차이를 사용해 복원함

## 커밋

`fix: synchronize overlay and donation state`
