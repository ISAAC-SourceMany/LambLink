...
- `A	src/LambLink.Mod/Game/DonationGameplayGate.cs`
- `A	src/LambLink.Mod/Game/DonationStoryLifecycle.cs`
...
- 보존 소스: `LambLink-v1.0.0-rc31-donation-safe-runtime-source.zip`
