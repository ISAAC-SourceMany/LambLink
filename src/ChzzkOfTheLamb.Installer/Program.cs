...
{
    private const string ReleaseVersion = "1.0.0-rc30";
    private const string DefaultManifestUrl = "https://d1gvw9ccym1qvn.cloudfront.net/releases/installer-manifest-1.0.0-rc30.json";
    ...
    {
        Text = "ChzzkOfTheLamb Setup 1.0.0-rc30";
        Width = 720;
        Height = 500;
    ...
    private static async Task<InstallerManifest> DownloadManifestAsync(string url, CancellationToken token)
    {
        ...
        http.DefaultRequestHeaders.UserAgent.ParseAdd("ChzzkOfTheLamb-Installer/1.0.0-rc30");
