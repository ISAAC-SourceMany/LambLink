...
// COTL's normal village follower-name UI is UIFollowerName. Patch every SetText overload and
// add the green CHZZK prefix only to the rendered TMP string. FollowerInfo.Name remains plain.
[HarmonyPatch]
