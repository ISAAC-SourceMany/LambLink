...
{
    private const string ReleaseVersion = "1.0.4";
    private const string DefaultManifestUrl = "https://d1gvw9ccym1qvn.cloudfront.net/releases/installer-manifest-1.0.4.json";
    ...
    private static async Task<InstallerManifest> DownloadManifestAsync(string url, CancellationToken token)
    {
        ...
        http.DefaultRequestHeaders.UserAgent.ParseAdd("LambLink-Installer/1.0.4");
