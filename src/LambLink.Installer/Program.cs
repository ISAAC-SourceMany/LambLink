...
internal sealed class InstallerForm : Form
{
    ...
    private const string DefaultManifestUrl = "https://d1gvw9ccym1qvn.cloudfront.net/releases/installer-manifest-1.0.1.json";
    ...
    private static async Task<InstallerManifest> DownloadManifestAsync(string url, CancellationToken token)
    {
        ...
        http.DefaultRequestHeaders.UserAgent.ParseAdd("LambLink-Installer/1.0.1");
